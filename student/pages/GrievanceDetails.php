							...
							<tfoot>
								<tr>
									<?php if ($row['Status'] == 'Closed') {?>
										<button class="btn  btn-success"  data-bs-toggle="modal" data-bs-target="#rejectGrievance"> ReOpen </button>
									<?php } ?>
								</tr>
							</tfoot>
						</table>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form>
          <div class="mb-3">
            <h1 for="recipient-name" class="col-form-label text-danger reject-response ">Are Sure to ReOpen Your Grievance</h1>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
        <button type="button" class="btn btn-success reject-btn" onclick="ReopenGrievance()">ReOpen</button>
      </div>
    </div>
  </div>
</div>
