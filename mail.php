...
<head>
	...
	<!-- Page title -->
	<title>Reset - Grievance Cell</title>
	<!-- Font awesome -->
                    ...
                    <div class="card mb-5 p-2  shadow rounded"  data-aos="zoom-out" data-aos-duration="1500">
                        <div class="card-body mt-2">
                            <div class="row mb-3">
                                ...
                                <h3 class=" text-center  p-3">Forgot Password</h3>
                            </div>
                            <form method="POST" >
                                <div class="mb-3 mt-2">
                                  <label for="Email" class="form-label"></label>
                                  <input type="email" name="UserName" placeholder="Email" class="form-control  shadow-none " id="Email" aria-describedby="emailHelp">
                                  
                                </div>
                                <div class="mb-3 ">
                                  <select id="UserType" class="form-select  shadow-none " name="UserType">
								...
								<div class="mt-3 text-center">
									<a href="index.php" class="btn  btn-dark border-light shadow-none w-25 mb-3 "> Home </a>
								</div>
								<?php }else {?>
                                <div class="mt-3 text-center">
