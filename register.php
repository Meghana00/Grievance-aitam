			...
			<div class="row mx-auto mt-5">
				...
				<div class="col-sm-6 col-md-6">
					<div class="card mb-5 p-2 shadow rounded">
						<div class="card-body">
							<div class="row mb-3">
								<h3 class="text-success"><?php echo htmlentities($Logintype) ?> Registration Form</h3> </div>
							<form method="POST">
								<div class="mb-3">
									<label for="fullname" class="form-label">Full Name</label>
									<input type="text" name="FullName" class="form-control border-success" id="Fullname"> </div>
								<div class="mb-3">
									<label for="rollid" class="form-label">RollNo/Employee Id</label>
									<input type="text" name="RollNo" class="form-control border-success" id="rollid"> </div>
								<div class="mb-3">
									<label for="Email" class="form-label">Email address</label>
									<input type="email" name="Email" class="form-control border-success" id="Email" aria-describedby="emailHelp"> </div>
								<div class="mb-3">
									<label for="department" class="form-label">Department</label>
									<select id="department" class="form-select border-success " name="Branch">
								...
								<div class="mb-3">
									...
									<select id="gender" class="form-select border-success" name="Gender">
										<option value="" selected>---Select---</option>
								...
								<div class="mb-3">
									...
									<input type="number" name="Mobile" class="form-control border-success" id="mobile"> 
								</div>
								<!-- <div class="mb-3">
								...
								<div class="row mt-4">
									<div class="col-sm-6"><a href="index.php" class="text-right mb-3">Already an account ?</a></div>
									<div class="col-sm-3"></div>
									<div class="col-sm-3">
										<button type="submit" name="Register" class="btn btn-primary border-success mb-3" style="background-color:#5cb85c;">Register</button>
									</div>
								</div>
